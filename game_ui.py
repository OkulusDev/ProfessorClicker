...
"}")
        ...
        self.money_label = QtWidgets.QLabel(parent=self.gridLayoutWidget)
        self.money_label.setStyleSheet("font: 12pt \"Source Code Pro\";\n"
"border: 1px solid #b8b8b8")
        self.money_label.setObjectName("money_label")
        self.gridLayout.addWidget(self.money_label, 0, 1, 1, 1)
        self.knowledge_label = QtWidgets.QLabel(parent=self.gridLayoutWidget)
        self.knowledge_label.setStyleSheet("font: 12pt \"Source Code Pro\";\n"
"border: 1px solid #b8b8b8")
        self.knowledge_label.setObjectName("knowledge_label")
        self.gridLayout.addWidget(self.knowledge_label, 0, 2, 1, 1)
        self.students_label = QtWidgets.QLabel(parent=self.gridLayoutWidget)
        self.students_label.setStyleSheet("font: 12pt \"Source Code Pro\";\n"
"border: 1px solid #b8b8b8")
        self.students_label.setObjectName("students_label")
        self.gridLayout.addWidget(self.students_label, 0, 0, 1, 1)
...
"background: #29333D;")
        ...
        self.tabWidget.setGeometry(QtCore.QRect(0, 200, 721, 481))
        ...
        self.takeBadStudent_btn = QtWidgets.QPushButton(parent=self.gridLayoutWidget_2)
        self.takeBadStudent_btn.setStyleSheet("")
        self.takeBadStudent_btn.setObjectName("takeBadStudent_btn")
        self.gridLayout_2.addWidget(self.takeBadStudent_btn, 2, 1, 1, 1)
        self.takeGoodStudent_btn = QtWidgets.QPushButton(parent=self.gridLayoutWidget_2)
        self.takeGoodStudent_btn.setStyleSheet("")
        self.takeGoodStudent_btn.setObjectName("takeGoodStudent_btn")
        self.gridLayout_2.addWidget(self.takeGoodStudent_btn, 0, 1, 1, 1)
        ...
        self.takeMiddleStudent_btn = QtWidgets.QPushButton(parent=self.gridLayoutWidget_2)
        self.takeMiddleStudent_btn.setStyleSheet("")
        self.takeMiddleStudent_btn.setObjectName("takeMiddleStudent_btn")
        self.gridLayout_2.addWidget(self.takeMiddleStudent_btn, 1, 1, 1, 1)
        self.label_13 = QtWidgets.QLabel(parent=self.gridLayoutWidget_2)
        self.label_13.setObjectName("label_13")
        self.gridLayout_2.addWidget(self.label_13, 3, 0, 1, 1)
        self.take_free_student = QtWidgets.QPushButton(parent=self.gridLayoutWidget_2)
        self.take_free_student.setStyleSheet("")
        self.take_free_student.setObjectName("take_free_student")
        self.gridLayout_2.addWidget(self.take_free_student, 3, 1, 1, 1)
...
"padding: 5px;")
        ...
        self.gridLayoutWidget_5.setGeometry(QtCore.QRect(0, 0, 721, 136))
        self.gridLayoutWidget_5.setObjectName("gridLayoutWidget_5")
        self.gridLayout_5 = QtWidgets.QGridLayout(self.gridLayoutWidget_5)
        self.gridLayout_5.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.up_university_ten_hundred_btn = QtWidgets.QPushButton(parent=self.gridLayoutWidget_5)
        self.up_university_ten_hundred_btn.setObjectName("up_university_ten_hundred_btn")
        self.gridLayout_5.addWidget(self.up_university_ten_hundred_btn, 1, 1, 1, 1)
        self.label_18 = QtWidgets.QLabel(parent=self.gridLayoutWidget_5)
        self.label_18.setObjectName("label_18")
        self.gridLayout_5.addWidget(self.label_18, 2, 0, 1, 1)
        self.up_university_ten_btn = QtWidgets.QPushButton(parent=self.gridLayoutWidget_5)
        self.up_university_ten_btn.setObjectName("up_university_ten_btn")
        self.gridLayout_5.addWidget(self.up_university_ten_btn, 0, 1, 1, 1)
        ...
        self.up_university_thousand_btn = QtWidgets.QPushButton(parent=self.gridLayoutWidget_5)
        self.up_university_thousand_btn.setObjectName("up_university_thousand_btn")
        self.gridLayout_5.addWidget(self.up_university_thousand_btn, 2, 1, 1, 1)
        self.tabWidget.addTab(self.tab_3, "")
        self.tab_2 = QtWidgets.QWidget()
        self.tab_2.setObjectName("tab_2")
        self.gridLayoutWidget_3 = QtWidgets.QWidget(parent=self.tab_2)
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(0, 0, 721, 181))
        self.gridLayoutWidget_3.setObjectName("gridLayoutWidget_3")
        self.gridLayout_4 = QtWidgets.QGridLayout(self.gridLayoutWidget_3)
        self.gridLayout_4.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.simple_course_btn = QtWidgets.QPushButton(parent=self.gridLayoutWidget_3)
        self.simple_course_btn.setObjectName("simple_course_btn")
        self.gridLayout_4.addWidget(self.simple_course_btn, 0, 1, 1, 1)
        ...
        self.hundred_math_btn = QtWidgets.QPushButton(parent=self.gridLayoutWidget_3)
        self.hundred_math_btn.setObjectName("hundred_math_btn")
        self.gridLayout_4.addWidget(self.hundred_math_btn, 1, 1, 1, 1)
        ...
        self.thousand_math_btn = QtWidgets.QPushButton(parent=self.gridLayoutWidget_3)
        self.thousand_math_btn.setObjectName("thousand_math_btn")
        self.gridLayout_4.addWidget(self.thousand_math_btn, 2, 1, 1, 1)
        self.five_thousands_math_btn = QtWidgets.QPushButton(parent=self.gridLayoutWidget_3)
        self.five_thousands_math_btn.setObjectName("five_thousands_math_btn")
        self.gridLayout_4.addWidget(self.five_thousands_math_btn, 3, 1, 1, 1)
        ...
        self.income_label = QtWidgets.QLabel(parent=self.gridLayoutWidget_4)
        self.income_label.setStyleSheet("font: 12pt \"Source Code Pro\";\n"
"border: 1px solid #b8b8b8")
        self.income_label.setObjectName("income_label")
        self.gridLayout_7.addWidget(self.income_label, 0, 0, 1, 1)
        self.player_lvl = QtWidgets.QLabel(parent=self.gridLayoutWidget_4)
        self.player_lvl.setStyleSheet("font: 12pt \"Source Code Pro\";\n"
"border: 1px solid #b8b8b8")
        self.player_lvl.setObjectName("player_lvl")
        self.gridLayout_7.addWidget(self.player_lvl, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.money_label.setText(_translate("MainWindow", "Деньги: 0$"))
        self.knowledge_label.setText(_translate("MainWindow", "Знание: 0"))
        self.students_label.setText(_translate("MainWindow", "Студенты: 0"))
        self.level_label.setText(_translate("MainWindow", "2 + x = 4"))
        self.label_5.setText(_translate("MainWindow", "Взять умного студента"))
        self.takeBadStudent_btn.setText(_translate("MainWindow", "15$"))
        self.takeGoodStudent_btn.setText(_translate("MainWindow", "100$"))
        ...
        self.takeMiddleStudent_btn.setText(_translate("MainWindow", "50$"))
        self.label_13.setText(_translate("MainWindow", "Взять ужасного студента"))
        self.take_free_student.setText(_translate("MainWindow", "Бесплатно"))
        ...
        self.up_university_ten_hundred_btn.setText(_translate("MainWindow", "1000$"))
        self.label_18.setText(_translate("MainWindow", "+10000 мест в университете"))
        self.up_university_ten_btn.setText(_translate("MainWindow", "100$"))
        self.label_16.setText(_translate("MainWindow", "+10 мест в университете"))
        self.label_17.setText(_translate("MainWindow", "+100 мест в университете"))
        self.up_university_thousand_btn.setText(_translate("MainWindow", "10000$"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("MainWindow", "Университет"))
        self.simple_course_btn.setText(_translate("MainWindow", "50$"))
        self.label_3.setText(_translate("MainWindow", "Средний курс математики"))
        self.label.setText(_translate("MainWindow", "Курсы повышения квалификации"))
        self.hundred_math_btn.setText(_translate("MainWindow", "100$"))
        self.label_2.setText(_translate("MainWindow", "Легкий курс математики"))
        self.label_4.setText(_translate("MainWindow", "Тяжелый курс математики"))
        self.thousand_math_btn.setText(_translate("MainWindow", "1000$"))
        self.five_thousands_math_btn.setText(_translate("MainWindow", "5000$"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "Курсы"))
        self.income_label.setText(_translate("MainWindow", "Доход: 0"))
        self.player_lvl.setText(_translate("MainWindow", "Уровень: 1"))
